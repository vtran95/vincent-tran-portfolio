    ...
    <div className="pb-20">
      ...
      <div className="relative flex h-screen w-full items-center justify-center bg-white dark:bg-black-100">
        ...
        <div className="flex justify-center relative my-20 z-10">
          <div className="max-w-[89vw] md:max-w-2xl xl:max-w-[40vw] flex flex-col items-center justify-center">
            <h2 className="uppercase tracking-widest text-xs text-center text-blue-100 max-w-80">
              Welcome to Vincent Tran&apos;s Portfolio
            </h2>

            <TextGenerateEffect
              className="text-[40px] md:text-5xl lg:text-6xl text-center mb-4"
            ...
            <p className="text-center md:tracking-wider mb-4 text-base md:text-lg lg:text-2xl">
              Hi, I&apos;m Vincent, a passionate software developer dedicated to
