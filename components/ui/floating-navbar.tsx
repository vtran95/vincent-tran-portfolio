          ...
          <div className="flex items-center gap-1">
            {navItems.map((navItem, idx: number) => (
              <a
                ...
                href={navItem.link}
                className={cn(
                  'relative flex items-center gap-1 rounded-full px-1 sm:px-4 py-2 text-sm font-medium text-neutral-600 transition-colors hover:bg-neutral-100 hover:text-neutral-900 dark:text-neutral-300 dark:hover:bg-white/10 dark:hover:text-white',
                )}
              >
